...
Woodwing's Digital Magazine Tools (http://www.woodwing.com/en/digital-magazine/ipad-now) are great to create magazines for tables devices. Unfortunately the images used to display the magazine could be much smaller and still shown in good quality. 

The ImageSqueezer-Script takes care of this problem by doing the following changes:
